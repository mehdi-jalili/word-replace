...
class w_replace_add_new_rule
{
    ...
    public function add_new_rule(){
        ...
        if ($this->where_to_replace_rule == 'page') {
            ...
            $this->page_id = isset($_POST['page_id']) ? intval( $_POST['page_id'] ) : null;
            $this->page_name = isset($_POST['page_name']) ? sanitize_text_field( wp_unslash( $_POST['page_name'] ) ) : null;
            ...
            $this->post_name = isset($_POST['post_name']) ? sanitize_text_field( wp_unslash( $_POST['post_name'] ) ) : null;
            ...
            $this->page_id = null;
            $this->post_id = null;
            // همچنین page_name و post_name را نیز صریحاً null کنید تا مقادیر قبلی باقی نمانند
            $this->page_name = null;
            $this->post_name = null;
        ...
        if ($w_new_rule_result === true) {
            // اصلاح متغیر اشتباه $result به $w_new_rule_result
            wp_send_json_success(array('result' => $w_new_rule_result));
        } else {
